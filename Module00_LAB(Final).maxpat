...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 604.0, 55.0, 150.0, 20.0 ],
					"text" : "Kevin Chau"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 419.249969, 1041.513428, 32.5, 18.0 ],
					"text" : "100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 453.0, 789.0, 32.5, 18.0 ],
					"text" : "120"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 400.75, 502.0, 32.5, 18.0 ],
					"text" : "90"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 127.5, 282.5, 32.5, 18.0 ],
					"text" : "110"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 383.0, 301.170013, 32.5, 18.0 ],
					"text" : "100"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 439.0, 1101.289917, 22.0, 140.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 439.0, 818.143433, 22.0, 140.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 427.0, 527.5, 22.0, 140.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 427.0, 277.0, 22.0, 140.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1271.529907, 1031.0, 150.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1259.529907, 771.0, 150.0, 34.0 ],
					"text" : "Manually patch wires to turn on steps"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1246.253906, 455.0, 150.0, 34.0 ],
					"text" : "Manually patch wires to turn on steps"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 439.0, 1259.97998, 150.0, 20.0 ],
					"text" : "Kick Drum"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 431.749969, 990.913452, 150.0, 20.0 ],
					"text" : "Sub Bass"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 43.5, 547.0, 150.0, 20.0 ],
					"text" : "***CLICK ME!!!! ***"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 527.333313, 114.967758, 150.0, 20.0 ],
					"text" : "Snare Pitch"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 427.0, 421.170013, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 427.0, 673.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					"addpoints" : [ 0.0, 0.0, 0, 10.638298, 0.933333, 0, 29.25532, 0.0, 0, 85.106384, 0.0, 0, 167.553192, 0.0, 0, 239.36171, 0.0, 0, 500.0, 0.0, 0 ],
					"domain" : 500.0,
					"id" : "obj-111",
					"maxclass" : "function",
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 427.0, 693.0, 150.0, 20.0 ],
					"text" : "Hi Hat"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 411.5, 443.5, 150.0, 20.0 ],
					"text" : "SNARE"
				}
