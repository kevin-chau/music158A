...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 6015.0, 420.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 420.0, 5860.0, 323.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 5925.0, 420.0, 20.0 ],
					"text" : "In Part 2, we'll look at the components of complex sounds."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 420.0, 5760.0, 315.0, 100.0 ],
					"scroll" : 2,
					"sono" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 105.0, 5760.0, 300.0, 100.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 45.0, 5787.5, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 45.0, 5715.0, 110.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 261.5, 5625.0, 32.5, 18.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 229.0, 5625.0, 32.5, 18.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 83.0, 5625.0, 34.0, 18.0 ],
					"text" : "stop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 45.0, 5625.0, 35.0, 18.0 ],
					"text" : "start"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 140.0, 5670.0, 346.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 45.0, 5670.0, 95.0, 20.0 ],
					"text" : "play~ music158"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 5580.0, 420.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 190.0, 5505.0, 50.0, 18.0 ],
					"text" : "replace"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 190.0, 5535.0, 100.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 5460.0, 420.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 229.0, 5310.0, 221.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 45.0, 5310.0, 175.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 5250.0, 420.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 5370.0, 420.0, 76.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 165.0, 5205.0, 214.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 45.0, 5205.0, 104.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 5160.0, 420.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 5115.0, 163.0, 26.0 ],
...
,
					"patching_rect" : [ 45.0, 5050.0, 19.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 45.0, 5010.0, 179.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 4905.0, 420.0, 90.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 465.0, 4205.0, 300.0, 100.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 750.0, 4305.0, 65.0, 20.0 ],
					"text" : "44,100 Hz"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 465.0, 4305.0, 38.0, 20.0 ],
					"text" : "0. Hz"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 4814.0, 410.0, 76.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 4574.0, 675.0, 240.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 4470.0, 380.0, 104.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 4425.0, 102.0, 21.0 ],
					"text" : "Reconstruction:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 4350.0, 398.0, 48.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 163.5, 4160.0, 113.0, 20.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 201.0, 4080.0, 308.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 100.0, 4080.0, 101.0, 18.0 ],
					"text" : "0., 44100. 30000"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 379.0, 4305.0, 65.0, 20.0 ],
					"text" : "22,050 Hz"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 100.0, 4305.0, 38.0, 20.0 ],
					"text" : "0. Hz"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 4305.0, 67.0, 20.0 ],
					"text" : "frequency:"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 100.0, 4205.0, 300.0, 100.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 100.0, 4160.0, 59.0, 20.0 ],
					"text" : "cycle~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "bang" ],
					"patching_rect" : [ 100.0, 4115.0, 49.0, 20.0 ],
					"text" : "line~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 4020.0, 453.0, 48.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 150.0, 3990.0, 218.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 45.0, 3990.0, 95.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 76.5, 3960.0, 32.5, 20.0 ],
					"text" : "/ 2."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 150.0, 3930.0, 83.0, 20.0 ],
					"text" : "sampling rate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 76.5, 3930.0, 72.5, 18.0 ]
				}
...
,
					"patching_rect" : [ 435.0, 3910.0, 19.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Helvetica Neue",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 435.0, 3870.0, 225.0, 32.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 3810.0, 380.0, 104.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 3330.0, 750.0, 450.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 3255.0, 750.0, 48.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 2790.0, 750.0, 450.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 2700.0, 380.0, 76.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 2670.0, 68.0, 21.0 ],
					"text" : "Sampling:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 1980.0, 424.0, 48.0 ],
					"text" : "The sine-sweep across the range of the human hearing patch above can be used here to observe our sensitivity to frequencies between 2,000 and 4,000 Hz."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 1785.0, 69.0, 21.0 ],
					"text" : "Loudness:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 1170.0, 145.0, 21.0 ],
					"text" : "The Critical Bandwidth:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 705.0, 140.0, 21.0 ],
					"text" : "Frequency Perception:"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 41.0, 1875.0, 212.0, 18.0 ],
					"text" : "http://en.wikipedia.org/wiki/Loudness",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 1815.0, 427.0, 48.0 ],
					"text" : "In lab 1, we used amplitude envelopes (lines, or curves) to change the volume of our sound. Perception of loudness, however, is also dependent on frequency:"
				}
...
,
					"patching_rect" : [ 41.0, 1911.0, 19.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Helvetica Neue",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 56.0, 1905.0, 364.0, 18.0 ],
					"text" : "http://en.wikipedia.org/wiki/Fletcher%E2%80%93Munson_curves",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 1656.0, 424.0, 76.0 ],
					"text" : "The region where one frequency is perceived when two are sounding is known as the critical bandwidth, and is dependent on frequency. The test above uses 440. Hz, but you may alter the patch above to see that the width of the region characterized by a presence of a singular, beating frequency changes according to frequency."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "float" ],
					"patching_rect" : [ 108.0, 1416.0, 56.0, 20.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 1596.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 30.0, 1536.0, 105.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 30.0, 1491.0, 89.0, 20.0 ],
					"text" : "+~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 1311.0, 101.0, 18.0 ],
					"text" : "220., 550. 30000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "bang" ],
					"patching_rect" : [ 30.0, 1341.0, 63.0, 20.0 ],
					"text" : "line~ 220."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 170.0, 1416.0, 307.0, 20.0 ],
					"text" : "we will sweep this cycle~'s frequency from 330. to 550."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 30.0, 1416.0, 72.0, 20.0 ],
					"text" : "cycle~ 220."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 170.0, 1446.0, 228.0, 20.0 ],
					"text" : "this oscillator's frequency will remain still"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 100.0, 1446.0, 72.0, 20.0 ],
					"text" : "cycle~ 440."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 1206.0, 398.0, 90.0 ],
					"text" : "The spiral shape of the inner ear has dedicated regions responsible for particular frequencies. When two sine waves are close to each other (that is, their value of their difference is relatively small), we cease to perceive two unique frequencies and hear just one. How close do frequencies have to be to each other for this to occur? We can reproduce the experiment in Max:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 235.0, 1596.0, 275.0, 20.0 ],
					"text" : "this frequency is the upper limit of your hearing...."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 160.0, 852.5, 276.0, 20.0 ],
					"text" : "click this the moment you no longer hear sound..."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 115.0, 975.0, 117.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 115.0, 840.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 115.0, 945.0, 117.0, 18.0 ],
					"text" : "0."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 235.0, 1536.0, 70.0, 20.0 ],
					"text" : "(frequency)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "float" ],
					"patching_rect" : [ 142.0, 915.0, 90.0, 20.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 145.0, 1020.0, 195.0, 60.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 145.0, 795.0, 290.0, 20.0 ],
					"text" : "We will sweep a sine wave from 0. Hz to 20,000. Hz."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 795.0, 101.0, 18.0 ],
					"text" : "0., 20000. 30000"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 1080.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 30.0, 1020.0, 105.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 30.0, 930.0, 59.0, 20.0 ],
					"text" : "cycle~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "bang" ],
					"patching_rect" : [ 30.0, 840.0, 49.0, 20.0 ],
					"text" : "line~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 735.0, 386.0, 34.0 ],
					"text" : "We can use the same objects we've used in Lab 1 to test the limits of human hearing:"
				}
...
,
					"patching_rect" : [ 30.0, 655.0, 19.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Helvetica Neue",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 615.0, 276.0, 18.0 ],
					"text" : "http://www.youtube.com/watch?v=0NJ_EAQjR3c",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 570.0, 129.0, 26.0 ],
					"text" : "The Human Ear"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 2595.0, 380.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 330.0, 2515.0, 91.0, 20.0 ],
					"text" : "spectroscope~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 2475.0, 300.0, 100.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 30.0, 2385.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 2340.0, 380.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 247.0, 2265.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 244.5, 2310.0, 50.0, 20.0 ],
					"text" : "ezadc~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 102.5, 2310.0, 50.0, 20.0 ],
					"text" : "ezdac~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 105.0, 2265.0, 45.0, 45.0 ]
				}
...
,
					"patching_rect" : [ 30.0, 2170.0, 19.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Helvetica Neue",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 2130.0, 229.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 2205.0, 380.0, 48.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 2085.0, 234.0, 26.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 450.0, 380.0, 76.0 ],
					"text" : "Note that our primary interest with sound lies from the physiological & psychological definition of sound. Discussion of the physical processes that cause sound to happen, however, is unavoidable. To realize compelling music (structure, design, emotion, etc.) we will need to create sound waves of our own."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 330.0, 195.0, 18.0 ],
					"text" : "http://en.wikipedia.org/wiki/Sound",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 285.0, 380.0, 34.0 ],
					"text" : "Click on the following blue message boxes to open them links in the browser:"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 365.0, 389.0, 18.0 ],
					"text" : "http://www.npr.org/2014/04/09/300563606/what-does-sound-look-like",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 240.0, 118.0, 26.0 ],
					"text" : "Sound Waves:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 105.0, 395.0, 78.0 ],
					"text" : "This week, we will spend some time looking at the nature of sound - both as an acoustic phenomenon and its digital representation.\n\nSome of the discussion this week will lie outside of Max and will be presented during the lecture hours.",
...
, 			{
				"box" : 				{
					...
					"text" : "Week 02 // Digital Audio Primer / Part 1"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "Screen Shot 2014-09-13 at 6.23.03 PM.png",
				"bootpath" : "/Users/ilyarostovtsev/Desktop",
				"patcherrelativepath" : "../../../../../Desktop",
				"type" : "PNG ",
				"implicit" : 1
			}
, 			{
				"name" : "Screen Shot 2014-09-13 at 6.23.24 PM.png",
				"bootpath" : "/Users/ilyarostovtsev/Desktop",
				"patcherrelativepath" : "../../../../../Desktop",
				"type" : "PNG ",
				"implicit" : 1
