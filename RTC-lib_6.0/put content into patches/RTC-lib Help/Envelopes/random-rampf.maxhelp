	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 64.0, 308.0, 50.0, 20.0 ],
					"fontsize" : 12.0,
					"id" : "obj-39",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 116.0, 308.0, 44.0, 20.0 ],
					"fontsize" : 12.0,
					"id" : "obj-42"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 483.0, 328.0, 65.0, 20.0 ],
					"fontsize" : 12.0,
					"id" : "obj-28"
				}
...
, 			{
				"box" : 				{
					...
					"fontface" : 1,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 484.0, 308.0, 38.0, 20.0 ],
					"fontsize" : 12.0,
					"id" : "obj-10",
					"triscale" : 0.9,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 273.0, 328.0, 123.0, 20.0 ],
					"fontsize" : 12.0,
					"id" : "obj-11"
				}
...
, 			{
				"box" : 				{
					...
					"fontface" : 1,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 274.0, 308.0, 30.0, 20.0 ],
					"fontsize" : 12.0,
					"id" : "obj-12",
					"triscale" : 0.9,
					"bgcolor" : [ 0.866667, 0.866667, 0.866667, 1.0 ],
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "random-rampf 0.5 22.7 5 1000 4000 7",
					"fontname" : "Arial",
					"numinlets" : 7,
					"numoutlets" : 3,
					"outlettype" : [ "", "", "float" ],
...
, 			{
				"box" : 				{
					...
					"fontface" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 145.0, 120.0, 94.0, 16.0 ],
					"fontsize" : 10.0,
					"id" : "obj-26",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"bgcolor" : [ 0.360784, 0.360784, 0.360784, 1.0 ]
...
, 			{
				"box" : 				{
					...
					"fontface" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 65.0, 120.0, 75.0, 16.0 ],
					"fontsize" : 10.0,
					"id" : "obj-22",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"bgcolor" : [ 0.360784, 0.360784, 0.360784, 1.0 ]
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 0.0, 423.0, 173.0, 18.0 ],
					"fontsize" : 10.0,
					"id" : "obj-9"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Float version of random-ramp. Generates randomly fluctuating shapes of a given value scale (defined by a min and a max value and a certain number of values) within a time scale (defined by a min and a max ramp time and a certain number of values). A rhythm bang set to the left inlet outputs a value value. A stop message sent to the same inlet will stop the whole process.",
					"linecount" : 4,
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 0.0, 55.0, 576.0, 62.0 ],
					"fontsize" : 12.0,
					"id" : "obj-16"
				}
