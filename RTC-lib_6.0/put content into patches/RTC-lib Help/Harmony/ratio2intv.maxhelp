...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 92.0, 145.0, 59.0, 20.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 92.0, 177.0, 59.0, 20.0 ],
					"text" : "ratio2intv"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 92.0, 209.0, 59.0, 20.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 152.0, 145.0, 55.0, 24.0 ],
					"text" : "ratio"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 152.0, 210.0, 66.0, 24.0 ],
					"text" : "interval"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 0.0, 254.0, 162.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "Converts a ratio into an interval (int = tempered or float = any micro- interval)."
				}
