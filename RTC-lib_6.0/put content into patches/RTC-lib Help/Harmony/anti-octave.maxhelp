...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"fontname" : "Arial",
					"patching_rect" : [ 37.0, 207.0, 69.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "flashes if an octave would have occured",
					"id" : "obj-17",
					"fontsize" : 12.0,
					"numinlets" : 1,
					"numoutlets" : 0,
					"fontname" : "Arial",
					"patching_rect" : [ 128.0, 207.0, 250.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"patching_rect" : [ 165.0, 88.0, 67.0, 16.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"patching_rect" : [ 236.0, 88.0, 79.0, 16.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"patching_rect" : [ 64.0, 88.0, 98.0, 16.0 ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Filters out octaves between two consecutive notes and outputs a bang from right outlet whenever an octave has occured.",
					"linecount" : 2,
					"id" : "obj-16",
					"fontsize" : 12.0,
					"numinlets" : 1,
