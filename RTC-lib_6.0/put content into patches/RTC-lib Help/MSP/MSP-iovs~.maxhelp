	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 12.0, 152.0, 30.0, 20.0 ],
					"fontsize" : 12.0,
					"id" : "obj-1"
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numinlets" : 1,
					"items" : [ 16, ",", 32, ",", 64, ",", 128, ",", 256, ",", 512, ",", 1024, ",", 2048, ",", 4096, ",", 8192 ],
					"numoutlets" : 3,
					"types" : [  ],
					"outlettype" : [ "int", "", "" ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 76.0, 195.0, 92.0, 20.0 ],
					"fontsize" : 12.0,
					"id" : "obj-4"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "select I/O vector size",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 129.0, 152.0, 122.0, 20.0 ],
					"fontsize" : 12.0,
					"id" : "obj-13"
				}
...
, 			{
				"box" : 				{
					...
					"fontface" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 206.0, 90.0, 67.0, 16.0 ],
					"fontsize" : 10.0,
					"id" : "obj-2",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"bgcolor" : [ 0.360784, 0.360784, 0.360784, 1.0 ]
...
, 			{
				"box" : 				{
					...
					"fontface" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 150.0, 90.0, 51.0, 16.0 ],
					"fontsize" : 10.0,
					"id" : "obj-26",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"bgcolor" : [ 0.360784, 0.360784, 0.360784, 1.0 ]
...
, 			{
				"box" : 				{
					...
					"fontface" : 3,
					"patching_rect" : [ 0.0, 1.0, 82.0, 23.0 ],
					"fontsize" : 14.0,
					"id" : "obj-15",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Sets the I/O vector size of MSP. Watch the DSP Status window!",
					"linecount" : 2,
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 0.0, 51.0, 305.0, 34.0 ],
					"fontsize" : 12.0,
					"id" : "obj-16"
				}
